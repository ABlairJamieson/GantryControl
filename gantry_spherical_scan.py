...
def get_gantry_settings(cam, scanpts, gantry_to_target_offset_mm,
    ...
    ----------
    cam : camera object
        Contains camera position (rc) and direction (dc)
    scanpts : list of np.array
    ...
    for r in scanpts:
        ...
        gsets.append([gantry_pos[0], gantry_pos[1], gantry_pos[2], phi, theta])
